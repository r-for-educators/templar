# Getting help with templar

Thanks for using templar. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/templar/issues) to make sure the 
